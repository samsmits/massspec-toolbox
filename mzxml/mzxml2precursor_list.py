...
filename_base = os.path.basename(filename_mzXML).replace('.mzXML','').replace('.gz','')
...
if( filename_mzXML.endswith('.gz') ):
    f_mzXML = gzip.open(filename_mzXML,'rb')
